...
public class FileHelperExampleAgent extends BackupAgentHelper {
     ...
     */
	 //“关键”字符串通过添加一个助手是一个令牌使用的时候出现 　　
	 //*消除歧义实体之间提供多个不同的帮手 　　
	 //*对象。他们只需要的帮手在此中是独一无二的 　　
	 //*一个代理类,而不是全球uniqu
     ...
     */
	 //{ @link android.app.backup。FileBackupHelper FileBackupHelper }类*几乎所有的工作为我们的用例:备份和恢复*
	 //文件存储在我们的应用程序的getFilesDir()的位置。它将还*处理文件存储
    @Override
